...
int main() {
    ...
    // Create a Box
    Quad* box = new Quad(glm::vec2{0, 0}, 400, 400, glm::vec3{1.0f, 0.0f, 0.0f},
                         PointType::Pixel);

    // Create a Point
    Point* point =
        new Point(glm::vec2{0.0f, 0.0f}, glm::vec3{0.0f, 1.0f, 0.0f});

    // Create a circle
    Circle* circle =
        new Circle(glm::vec2{0.5f, 0.0f}, glm::vec3{0.0f, 0.0f, 1.0f}, 10.0f);

    std::vector<glm::vec2> points = {glm::vec2{0.0f, 0.0f},
                                     glm::vec2{1.0f, 1.0f}};
    Line2D* line =
        new Line2D(points, glm::vec3{1.0, 1.0, 1.0}, PointType::Fraction);
    ...
    Triangle* tri =
        new Triangle(glm::vec2{100.0f, 100.0f}, glm::vec2{200.0f, 300.0f},
